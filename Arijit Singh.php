...
<head>
  ...
  <style>
    * {
    ...
    .daily-mix-banner {
      background: linear-gradient(to bottom, #ed8d55, #121212 100%);
      padding: 20px;
    }
...
<body>
      ...
      <div class="daily-mix">
        <div class="daily-mix-banner">
          <div class="daily-mix-header">
            <img src="Photos/Arijit.jpg" alt="Arijit Singh">
            <div class="info">
              <p>Verified Artist</p>
              <h2>Arijit Singh</h2>
              <p>47,208,118 monthly listeners</p>
        ...
        <h2 style="margin-left: 20px;">Popular</h2>
        ...
        <h2 style="margin-top: 50px; color: white; margin-left: 10px;">About</h2>
        <div class="about-section">
          <!-- Rank badge -->
          <div class="rank-badge">
            <span class="rank-number">#60</span>
            <span class="rank-label">in the world</span>
          </div>

          <!-- Content -->

          <div class="about-content">
            <img src="Photos/Arijit.jpg" alt="Arijit Singh" class="about-image">

            <div class="about-text">
              <p class="listeners">47,208,118 monthly listeners</p>
              <p class="bio">Celebrating and sharing love for music with all of you.</p>
              <p class="links">
                <a href="https://www.instagram.com/arijitsingh?igsh=NnVwcWg5eG9hMHll" target="_blank">Instagram</a>|
                <a href="https://www.facebook.com/ArijitSingh?mibextid=LQQJ4d" target="_blank">Facebook</a>|
                <a href="https://youtube.com/@official_arijitsingh?feature=shared" target="_blank">YouTube</a>|
                <a href="https://x.com/arijitsingh?s=21" target="_blank">X</a>
              </p>
            </div>
          </div>
        </div>
  ...
  <div class="player-bar">
    <div class="now-playing">
      <img id="songCover" src="Photos/Apna bana le.png">
      <div>
        <div id="songTitle">Apna Bana Le</div>
        <div id="songArtist" style="font-size: 12px; color: #b3b3b3;">Arijit Singh</div>
      </div>
    </div>
